      ...
      {pureRecomendations ? (
            ...
            {pureRecomendations.map(recommendation => (
              <div className="singleRecomendationHolder" key={recommendation.id}>
                ...
                <section className="extras">
                  ...
                  <a href="https://www.linkedin.com/in/rebecca-karungi/" target="_blank" rel="noreferrer" className="readmore">Read More...</a>
                </section>
              </div>
            ))}
          </Carousel>
        ...
        <div className="recommendationsNotice">
          <p className="notice">
            ...
            <a href="https://www.linkedin.com/in/rebecca-karungi/" target="_blank" rel="noreferrer">My LinkedIn page</a>
            , or refresh the page.
          </p>
        </div>
      )}
